...
<!--                 <thead>
                    ...
                    <c:forEach items="${trainExamList}" var="trainExam" varStatus="status">
                        <tr>
                        	<td align="center" width="5%">
                                <%-- <img src="<%=basePath%>images/exam_left_bg.png" style="width: 40px;height: 40px;" class="emp_top_logo"> --%>
                            ...
                            <td align="center" width="10%">
                                <%-- <a href="javascript:toConfirm('${trainExam.id}');"><img src="<%=basePath%>images/exam_right_confirm.png" class="emp_top_logo" style="width: 35px;height: 35px;" border="0"></a> --%>
                                <input type="button" onclick="toConfirm('${trainExam.id}');" class="detailBtn" value="开始考试" />
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div class="page_div">
            ...
            <%-- <div class="mobile_page_right_div">${totalPages }/${totalCount }</div> --%>
        </div>
    </form>
</body>
</html>