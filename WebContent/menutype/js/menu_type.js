    ...
    if(Number(total_count) > 0){
        ...
        $.jqPaginator('#pagination', {
            ...
            onPageChange: function (num, type) {
                if(type=="change"){
                    window.location.href="getMenuTypeDataList.action?page="+num;
                }
            }
        });
...
function toAdd(){
	window.location.href = "toAddMenuType.action";
}
function toInput(){
...
//编辑
function toEdit(id){
	window.location.href = "toEditMenuType.action?trainInfo.id="+id;
}
//删除
